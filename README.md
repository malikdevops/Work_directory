...
The objectives of this practice project are to ensure that you are able to manage a docker infrastructure, so you will be evaluated about the following
...
The work is to build one container for each module an make them interact with each other
